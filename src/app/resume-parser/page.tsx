...
const RESUME_EXAMPLES = [
  {
    fileUrl: "resume-example/Yogesh_SWE_Resume.pdf",
    description: (
      <span>

        <Link href="https://drive.google.com/file/d/17M2uC8uPyoManaq8BsPCcRE2_n8WzJND/view">
          Link
        </Link>
      </span>
    ),
  ...
  {
    fileUrl: "resume-example/Yash_Resume.pdf",
    description: (
      <span>

        <Link href="https://drive.google.com/file/d/10kQoqKGAY7RLdDRRfHMAduUuGTNpsESJ/view">Link</Link>
      </span>
    ),
  },
];
      ...
      <div className="grid md:grid-cols-6">
        <div className="flex justify-center px-2 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:justify-end">
          <section className="mt-5 grow px-4 md:max-w-[600px] md:px-0">
            <div className="h-full aspect-w-7">
        ...
        <div className="flex px-6 text-gray-900 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
          ...
          <section className="max-w-[600px] grow">
            <Heading className=" text-center md:text-5xl !mt-4">
              Resume Parser 
            </Heading>
            ...
            <Paragraph>
              ...
              Tracking Systems (ATS) used in job applications. 
            </Paragraph>
            <div className="mt-3">
              <ResumeDropzone
